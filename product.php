...
if(isset($_GET["subcatid"]))
  {
  $resultpro= mysql_query("select * from products where subcat_id='$_GET[subcatid]'");
  }
  else
  {
	    $resultpro= mysql_query("select * from products order by prod_id desc");
  }
    	...
    	<div class="panel">
			...
			<div class="backgrounds">
				...
				<div class="item item_1">
					<img src="pics/skin.jpg" alt="Slider 01" width="670" height="344" />
				</div><!-- /item -->
				
				<div class="item item_2"><img src="pics/jean.jpg" alt="Slider 02" width="686" height="316" /></div><!-- /item -->
				
				<div class="item item_3">
					<img src="pics/pant.jpg" alt="Slider 03" width="685" height="316" />
				</div><!-- /item -->
...
{
	echo "<li><a href='viewsubcategory.php?catid=$row1[cid]'>$row1[catname]</a></li>";
        ...
        <div id="content" class="float_r">
            ...
            <div class="product_box no_margin_right">
               ...
               <a href="productdetail.php"> <img src=<?php echo $row[imge];?> alt="Image 01" width="100" height="100"/></a>
                ...
                <a href="shoppingcart.php?prodid=<?php echo $row[prod_id];?>" class="add_to_card">Buy Now</a>
