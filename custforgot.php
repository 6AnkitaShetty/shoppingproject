...
{
	$result=mysql_query("select * from customerregistration where email='$_POST[email]' and dob='$_POST[dob]'");
...
if(isset($_POST[submit1]))
{
 ...
 {
	$res="update customerregistration set pwd='$_POST[pwd]' where email='$_POST[email]'";
	if(mysql_query($res))
	{
...
<tr>
<th height="51" colspan="2"><center> <h3><font color="white">Forgot Password (Customer)</font></h3></center></th></tr>
<tr>
...
<tr><td height="69" colspan=2><center><input type="submit" value="Forgot Password" name="submit" onclick="return validate()" class="button-1"/></center></td></tr>
<tr><td height="37" colspan="2"><center>Login here <a href="customerlogin.php"><font color="red">Login</font></a></center></td></tr>
</table>
</form>
</center>
<?php
...
<input type="hidden" name="token" value="<?= $new_token ?>" />
<tr>
<th height="36" colspan=2><center> <h3><font color="white">Forgot password(Customer)</font></h3></center></th></tr>
<tr>
<th height="47" colspan="2"><center>Field marked <font color="red">* </font>are mandantory</center></th></tr>
...
<tr>
<td height="62">
New Password<font color="red">*</font>:</td><td align="center"><input type="password" name="pwd" title="Enter the new password"  placeholder="New Password"/></td></tr></tr>
...
?>
 <center> <img src="pics/zxc.jpg" width="329" height="160"></center>
